    ...
    public void createButtonList() {//Tạo tự động bộ bài theo số lượng đã cho
        ...
        for (int i = 0; i < x; i++) {
            ...
            for (int j = 1; j <= y; j++) {
                ...
                dotparams.setMargins(10, 0, 10, 0);//Chỉnh khoảng cách giữa các lá bài
                dotparams.height =  ((height - 500 -(x-1)*10 )/x);//Chỉnh độ dài mỗi lá bài.
                dotparams.width =  ((width -(y-1)*20)/y);//Chỉnh rộng.
